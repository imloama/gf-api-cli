...
const templateApiServiceIndexContent = `
package service
...
type i{TplTableNameCamelLowerCase}Service struct {
}

var {TplTableNameCamelLowerCase}Service = new(i{TplTableNameCamelLowerCase}Service)

// 新增
func(svr *i{TplTableNameCamelLowerCase}Service)Insert(data *model.{TplTableNameCamelCase})error{
	rows
}

// 修改
func(svr *i{TplTableNameCamelLowerCase}Service)Insert()(*model.{TplTableNameCamelCase}, error){
